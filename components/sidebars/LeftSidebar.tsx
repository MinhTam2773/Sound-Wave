        ...
        <div className="flex flex-col gap-[25px]">
          ...
          <div className="flex flex-col gap-[25px] w-full">
            ...
            <nav className="flex flex-col gap-[15px] w-full">
              {/* Home */}
              <div className="relative flex items-center gap-2.5 w-full min-h-[45px] rounded-[10px] p-0 cursor-pointer bg-linear-to-r overflow-visible">
              ...
              <div className="flex items-center gap-[10px] w-full min-h-[45px] rounded-[10px] p-0 cursor-pointer hover:bg-white/10 transition-colors pl-[15px]">
                <img
                  ...
                  alt="Music"
                />
                <span className="text-white text-[18px] font-medium">Music</span>
              </div>
              ...
              <div className="flex items-center gap-[10px] w-full min-h-[45px] rounded-[10px] p-0 cursor-pointer hover:bg-white/10 transition-colors pl-[15px]">
                <img
                  ...
                  alt="Library"
                />
                <span className="text-white text-[18px] font-medium">Library</span>
              </div>
              ...
              <div className="flex items-center gap-[10px] w-full min-h-[45px] rounded-[10px] p-0 cursor-pointer hover:bg-white/10 transition-colors pl-[15px]">
                <img
                  ...
                  alt="Explore"
                />
                <span className="text-white text-[18px] font-medium">Explore</span>
              </div>
              ...
              <div className="flex items-center gap-[10px] w-full min-h-[45px] rounded-[10px] p-0 cursor-pointer hover:bg-white/10 transition-colors pl-[15px] pt-[11px] pb-[11px]">
                <img
                  ...
                  alt="Notifications"
                />
                <span className="text-white text-[18px] font-medium">Notifications</span>
              </div>
              ...
              <div className="flex items-center gap-[10px] w-full min-h-[45px] rounded-[10px] p-0 cursor-pointer hover:bg-white/10 transition-colors pl-[15px]">
                <img
                  ...
                  alt="Settings"
                />
                <span className="text-white text-[18px] font-medium">Settings</span>
              </div>
              ...
              <div className="flex items-center gap-[10px] w-full min-h-[45px] rounded-[10px] p-0 cursor-pointer hover:bg-white/10 transition-colors pl-[15px]">
                <img
                  ...
                  alt="Search"
                />
                <span className="text-white text-[18px] font-medium">Search</span>
              </div>
            </nav>
          </div>
        </div>
