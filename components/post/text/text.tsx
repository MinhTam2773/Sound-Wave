...
export default function TextPost({
  ...
  return (
    <div className="relative w-[709px] max-w-full mx-auto">
      {/* Gradient border */}
      ...
      {/* Card content */}
      <div className="relative z-10 bg-[#323232] rounded-[15px] border-[0.5px] border-[#776f6f] p-[14px_15px] flex flex-col gap-[15px] w-full overflow-hidden">
        {/* Header */}
