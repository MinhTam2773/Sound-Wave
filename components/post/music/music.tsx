...
export default function MusicPost() {
  ...
  return (
    <div className="relative bg-[#323232] rounded-[15px] border-[0.5px] border-[#776f6f] p-[14px_15px] flex flex-col gap-[15px] w-full overflow-hidden">
      {/* Header */}
      <div className="flex flex-row items-center justify-between w-full gap-[112px]">
      ...
      {/* Caption */}
      <div className="text-[1.05rem] text-white tracking-tight leading-relaxed font-normal">
        Omg this new song is amazing!!!
      </div>

      {/* Music Thumbnail with Play Button */}
      <div className="relative w-full flex items-center justify-center mt-2">
        <div
          className="relative w-[75px] h-[75px] rounded-[5px] bg-gradient-to-r from-[#9000ff] to-[#ffc300] flex items-center justify-center cursor-pointer"
          onClick={togglePlay}
        >
      ...
      {/* Social Icons */}
      <div className="flex flex-col gap-[6px] w-full p-0 mt-3">
